...
export const servicesData: Service[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        title: 'What to Expect in Your Session',
        body: 'After assessing your condition, cups are placed on the affected areas creating suction that draws tissue into the cup. You\'ll feel a pulling sensation but it should not be painful. Cups may remain stationary for 5-15 minutes, or be moved across lubricated skin in a massage-like technique. Circular marks typically appear where cups were placed, which is normal and indicates increased circulation. Treatment areas are often combined with other therapies.',
      },
      {
        title: 'Benefits',
    ...
    sections: [
      {
        ...
        body: 'Manual lymphatic drainage (MLD) is a gentle, specialized massage technique designed to stimulate the lymphatic system. Using light, rhythmic strokes in specific directions, we encourage the movement of lymph fluid through the body. This helps reduce swelling, supports immune function, and promotes the removal of waste products and toxins. The technique requires specialized training and differs significantly from traditional massage.',
      },
      {
        title: 'Who is it for?',
      ...
      {
        title: 'What to Expect in Your Session',
        body: 'Treatment involves very light, gentle strokes following the direction of lymph flow toward lymph nodes. The pressure is much lighter than traditional massage. Sessions typically begin at the neck to open major drainage pathways, then progress to affected areas. You\'ll likely find the treatment deeply relaxing. Sessions last 45-60 minutes, and you may notice increased urination afterward as your body processes mobilized fluid.',
      },
      {
        title: 'Benefits',
    ...
    sections: [
      {
        ...
        body: 'Compression therapy uses specialized pneumatic compression devices with inflatable sleeves or boots that apply sequential, rhythmic pressure to the limbs. This massage-like compression mimics the natural muscle pumping action, significantly improving blood flow and lymphatic drainage. The system is commonly used by athletes for recovery but also benefits anyone with circulation issues or swelling.',
      },
      {
        title: 'Who is it for?',
      ...
      {
        title: 'What to Expect in Your Session',
        body: 'You\'ll be fitted with compression sleeves or boots (for legs or arms) while seated or lying comfortably. The device inflates and deflates in sequential zones, creating a wave-like massage sensation moving toward the heart. Sessions typically last 20-30 minutes and feel like a deep but comfortable massage. Many people find it relaxing enough to rest or use their phone during treatment.',
      },
      {
        title: 'Benefits',
        body: 'Regular compression therapy sessions provide multiple recovery advantages:',
        bullets: [
    ...
    sections: [
      {
        ...
        body: 'Cryotherapy, or cold therapy, involves the therapeutic application of cold to injured or inflamed tissues. We use various methods including ice packs, cold compression devices, and controlled cold application techniques to reduce tissue temperature. This decreases metabolic activity, reduces inflammation, and provides effective pain relief. Cryotherapy is particularly beneficial in the acute phase of injury and for managing chronic inflammatory conditions.',
      },
      {
        title: 'Who is it for?',
      ...
      {
        title: 'What to Expect in Your Session',
        body: 'Cold therapy is applied to the affected area using appropriate methods based on your condition. Application typically lasts 10-20 minutes. You\'ll feel significant cold initially, which may become numb as treatment continues. We protect your skin to prevent ice burns. Cryotherapy is often combined with compression and elevation for maximum benefit, especially in acute injuries.',
      },
      {
        title: 'Benefits',
